...
public class MainActivity extends Activity implements OnSharedPreferenceChangeListener {
    ...
    public static final int LOCATION_UPDATED = 2000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeoLocation = (TextView) findViewById(R.id.txtGeoLocation);
        ...
        // This can be change to other way
        mHandle = new Handler() {
            @Override
            public void handleMessage(Message msg) {
                if (msg.what == LOCATION_UPDATED) {
                    ...
                    if (clientLocation.getGeoCoordinate() != null) {
                        mGeoLocation.setText("Longitude: " + clientLocation.getGeoCoordinate().getLongitude() + " Latitude: " + clientLocation.getGeoCoordinate().getLatitude());
                    }
                    mZoneName.setText(clientLocation.getZoneName());
