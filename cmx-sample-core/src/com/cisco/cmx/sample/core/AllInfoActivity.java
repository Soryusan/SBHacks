...
public class AllInfoActivity extends ActionBarActivity {
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_all_info,
					container, false);
			return rootView;
		}
	}
	...
	private void loadFloors(final CMXVenue venue) {
		cmxClientInstance.loadMaps(venue.getId(),
	...
	private void loadPois(final CMXFloor floor) {
		cmxClientInstance.loadPois(floor.getVenueId(), floor.getId(),
				new CMXPoisResponseHandler() {
					@Override
	...
	private class WaitforTaskFinish extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			for (CMXVenue venue : mVenues) {
				mTextViewAllInfo.append("Venue Name                    : "
						+ venue.getName() + "\n");
				mTextViewAllInfo.append("Venue ID                      : "
						+ venue.getId() + "\n");
				mTextViewAllInfo.append("Venue Street Address          : "
						+ venue.getStreetAddress() + "\n");
				mTextViewAllInfo.append("----  Floor Info For Venue "
						+ venue.getName() + " ----\n");
					...
					for (CMXFloor floor : mFloors.get(venue.getId())) {
						...
						mTextViewAllInfo
								.append("   Floor ID                   : "
										+ floor.getId() + "\n");
						mTextViewAllInfo
								.append("   Floor Hierarchy            : "
										+ floor.getHierarchy() + "\n");
						mTextViewAllInfo.append("-----  POI Info For Venue "
								+ venue.getName() + " -----\n");
