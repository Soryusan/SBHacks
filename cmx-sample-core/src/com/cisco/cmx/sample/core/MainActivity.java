...
public class MainActivity extends ActionBarActivity {
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		if (getIntent() != null && getIntent().getExtras() != null) {
			String serverIp = (String) getIntent().getExtras().get(
					EXTRA_SERVER_IP);
			String serverPort = (String) getIntent().getExtras().get(
					EXTRA_SERVER_PORT);
			if (serverIp != null) {
	...
	public void submitServer(View v) {
		...
		try {
			configuration.setServerAddress(serverAddressText.getText()
					.toString());
			...
			alertDialogBuilder.setPositiveButton(R.string.cmx_ok_dialog_bt,
		...
		CMXClient.getInstance().loadVenues(new CMXVenuesResponseHandler() {
			...
			public void onSuccess(List<CMXVenue> venues) {
				...
				intent.putParcelableArrayListExtra(VenueActivity.EXTRA_VENUES,
						activityVenues);
				intent.putExtra(EXTRA_SERVER_IP, serverAddressText.getText()
						.toString());
				intent.putExtra(EXTRA_SERVER_PORT, serverPortText.getText()
						.toString());
